...
export function Footer() {
  ...
  return (
    <footer className='grid py-12 w-[26.875rem] max-w-[26.875rem] grid-cols-1 items-center justify-center tablet:w-[40rem] tablet:max-w-[40rem] tablet-lg:w-[48rem] tablet-lg:max-w-[48rem] tablet-lg:px-[3.25rem] laptop:grid-cols-2 laptop:w-[64rem] laptop:max-w-[64rem] laptop-lg:w-[80rem] laptop-lg:max-w-[80rem] laptop-lg:grid-cols-3 desktop:w-[90rem] desktop:max-w-[90rem]'>
